...
export default function Form() {
    return (
        <div className='px-10 py-7 rounded-3xl bg-white border-2 border-gray-100'>
            ...
            <div className='mt-8'>
                ...
                <div className='mt-8 flex flex-col gap-y-4'>
                    <button className='active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01]  ease-in-out transform py-3 bg-violet-500 rounded-xl text-white font-bold text-lg'>Sign in</button>
                    <button 
